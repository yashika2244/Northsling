...
export default function Hero1({ showSVG = true }) {
  return (
   <section className="relative w-full  h-auto md:min-h-screen bg-black flex flex-col justify-start md:justify-center px-6 md:px-12 pt-24 md:pt-48 pb-16 overflow-hidden">
      ...
      {showSVG && (
        <motion.svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 800 800"
          className="absolute left-[65%] top-[25%] -translate-x-1/2 -translate-y-1/2 h-[180%] w-[180%] md:h-[140%] md:w-[140%] z-20"
          initial={{ rotate: 0, scale: 1 }}
