      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        >
          ...
          <span
            className={`font-extrabold text-2xl tracking-wide transition-all duration-300 ${
              isLight
                ? "text-gray-800"
                : "bg-gradient-to-r from-teal-300 via-cyan-400 to-blue-400 text-transparent bg-clip-text hover:tracking-wider"
            }`}
          >
            Northsling
          </span>
        ...
        <nav className="hidden md:flex items-center gap-10 text-[15px] font-semibold">
          {navLinks.map((link, i) => (
            ...
            >
              <span
                className={`bg-clip-text text-transparent transition-all duration-300 transform group-hover:scale-110 inline-block ${
                  isLight
                    ? "bg-gradient-to-r from-gray-800 to-gray-800 group-hover:from-teal-500 group-hover:to-cyan-500"
                    : "bg-gradient-to-r from-white to-white group-hover:from-teal-400 group-hover:to-cyan-400"
                }`}
              >
                {link.name}
              </span>
              <span className="absolute left-0 -bottom-1 h-[2px] w-0 bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-500 rounded-full transition-all duration-500 group-hover:w-full group-hover:shadow-[0_0_8px_rgba(34,211,238,0.8)]"></span>
            </motion.a>
          ))}
        </nav>
        ...
        >
          <X
            ...
            className={`transition-transform duration-500 group-hover:rotate-90 ${
              isLight ? "text-gray-700" : "text-white group-hover:text-cyan-300"
            }`}
          />
        </button>
      </div>
