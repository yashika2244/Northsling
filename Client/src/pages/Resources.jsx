...
export default function Resources() {
  const menuItems = ["News Room", "Insights / Blogs", "Press Releases"];
  ...
  const articlesData = {
    "News Room": [
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1633113216811-1b4b6df0e4f3?auto=format&fit=crop&w=1200&q=80",
      },
    ],
    "Insights / Blogs": [
      {
        title: "Driving Innovation with Edge AI for Smart Cities",
        image:
          "https://images.unsplash.com/photo-1558655146-364adaf1fcc9?auto=format&fit=crop&w=1200&q=80",
      },
      {
        title: "Exploring the Future of Sustainable Cloud Computing",
        image:
    ...
    "Press Releases": [
      {
        title: "TechCorp Expands AI Division to Empower Businesses in 2025",
        image:
          "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=1200&q=80",
      },
      {
        title: "Partnership Announcement: CloudEdge x GlobalData",
        image:
          "https://images.unsplash.com/photo-1605902711622-cfb43c4437d7?auto=format&fit=crop&w=1200&q=80",
      },
    ],
  };
  ...
  return (
    <section className="min-h-screen bg-gray-100 p-4 font-sans mx-2 rounded-2xl mt-2">
      <div className="max-w-7xl mx-auto bg-white rounded-2xl p-4 md:p-10 flex flex-col lg:flex-row gap-6 shadow-sm">
        {/* ===== Sidebar ===== */}
        <aside className="w-full lg:w-72 bg-white/80 backdrop-blur-xl shadow-md border-b lg:border-b-0 lg:border-r border-orange-200 p-4 flex flex-col sticky top-16 z-10 rounded-none lg:rounded-2xl">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {articlesData[active].map((post, idx) => (
                <motion.div
                  key={idx}
